...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/events/join/{invite_code}": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Invite Code from path",
                        "name": "invite_code",
                        "in": "path"
                    },
                    {
        ...
        "/events/redirect/{invite_code}": {
            "get": {
                ...
                "responses": {
                    "302": {
                        "description": "Redirect to iOS app",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/password/reset-redirect": {
            "get": {
                ...
                "responses": {
                    "302": {
                        "description": "Redirected to mobile app",
                        "schema": {
                            "type": "string"
                        }
                    },
    ...
    "tags": [
        ...
        {
            "description": "Push notification endpoints for registering device tokens and managing notification preferences",
            "name": "notifications"
        }
    ]
}`
